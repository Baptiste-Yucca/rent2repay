...
contract Rent2RepayHarnessTest is Test {
    ...
    function testExposedCalculateFees() public {
        ...
        assertGt(amountForRepaymentReduced, amountForRepayment, "Amount for repayment should be higher with reduced fees");
    }
    ...
    function testExposedIsNewPeriod() public {
        ...
        assertFalse(rent2Repay.exposed_isNewPeriod(user, address(wxdai)), "Should not be new period immediately after config");
