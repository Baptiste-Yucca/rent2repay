    ...
    try {
        ...
        switch (actionNum) {
            ...
            case 2: // Burn (simulé par transfer vers 0x0)
                ...
                const tokenAsUser = tokenContract.connect(userSigner);
            ...
            case 3: // Mint + Approve
                ...
                const userSigner2 = await ethers.getImpersonatedSigner(userAddress);
                const tokenAsUser2 = tokenContract.connect(userSigner2);
