...
interface IAToken is IERC20, IScaledBalanceToken, IInitializableAToken {
  ...
  /**
   * @notice Returns the address of the Rmm treasury, receiving the fees on this aToken.
   * @return Address of the Rmm treasury
   */
...
interface IInitializableAToken {
   ...
   * @param treasury The address of the Rmm treasury, receiving the fees on this aToken
  ...
  function initialize(
    ...
    IRmmIncentivesController incentivesController,
    uint8 aTokenDecimals,
 ...
 * @title IPool
 * @author Aave
 * @notice Defines the basic interface for an Rmm Pool.
 */
interface IPool {
  /**
   ...
   * @param receiveAToken True if the liquidators wants to receive the collateral aTokens, `false` if he wants
   * to receive the underlying collateral asset directly
	 * @return The actual amount of collateral received by the liquidator
	 * @return The actual amount of debt repaid by the liquidator
   */
...
interface IPoolAddressesProvider {
  ...
  /**
   * @notice Returns the id of the Rmm market to which this contract points to.
   ...
   * identify and validate multiple Rmm markets.
 ...
 * @author Aave
 * @notice Interface for the Rmm price oracle.
 */
...
/**
 * @title IRmmIncentivesController
 * @author Aave
 * @notice Defines the basic interface for an Rmm Incentives Controller.
 * @dev It only contains one single function, needed as a hook on aToken and debtToken transfers.
 */
interface IRmmIncentivesController {
  /**
 ...
 * @author Aave
 * @notice Defines the error messages emitted by the different contracts of the Rmm protocol
 */
library Errors {
...
library BorrowLogic {
   ...
   * Rmm protocol proportionally to their collateralization power. For isolated positions, it also increases the
   * isolated debt.
...
library SupplyLogic {
  ...
  /**
   * @notice Implements the supply feature. Through `supply()`, users supply assets to the Rmm protocol.
   ...
   * previously supplied in the Rmm protocol.
 ...
 * @title Pool contract
 * @author Aave
 * @notice Main point of interaction with an Rmm protocol's market
 * - Users can:
 *   # Supply
 *   # Withdraw
 *   # Borrow
...
contract Pool is VersionedInitializable, PoolStorage, IPool {
  ...
  function liquidationCall(
    ...
    return LiquidationLogic.executeLiquidationCall(
      _reserves,
      _reservesList,
      _usersConfig,
      _eModeCategories,
